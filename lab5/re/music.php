...
<html lang="en">
	...
	<body>
        ...
        <?php
            $fav_artist = array("Guns N' Roses", "Green Day","Blink182");
            $fav_artist[] = "Queen";
        ?>
		<!-- Ex 5: Favorite Artists from a File (Files) -->
        <?php
            $fav_artist = file("favorite.txt", FILE_IGNORE_NEW_LINES);
        ?>
		<div class="section">
			<h2>My Favorite Artists</h2>
            <ol>
                <?php
                    foreach($fav_artist as $art){
                        $under_art = implode("_", explode(" ", $art));
                ?>
                <li><a href="http://en.wikipedia.org/wiki/<?=$under_art?>"><?=$art?></a></li>
                <?php } ?>
            </ol>
<!--
			<ol>
